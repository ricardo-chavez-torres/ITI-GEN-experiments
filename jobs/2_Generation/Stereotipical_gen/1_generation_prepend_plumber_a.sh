...
#SBATCH --time=8:20:00
#SBATCH --output=GENERATED_plumber_a_%A.out
...
echo "**1. Generation Figure 6a for plumber**"
python generation.py \
    ...
    --prompt-path='./ckpts/a_headshot_of_a_person_Age_Male/prepend_prompt_embedding_a_headshot_of_a_plumber/basis_final_embed_29.pt' \
    --n_iter=200 \
    --n_samples=1
