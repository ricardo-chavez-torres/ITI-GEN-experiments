...
echo "**1. Generation Figure 6a for nurse**"
python generation.py \
    ...
    --prompt-path='./ckpts/a_headshot_of_a_person_Age_Male/prepend_prompt_embedding_a_headshot_of_a_nurse/basis_final_embed_29.pt' \
    --n_iter=200 \
    --skip_grid \
    --n_samples=1